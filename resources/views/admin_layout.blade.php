...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="/"><i class="fa fa-book"></i> <span>Ordenes</span></a></li>
                <li><a href="/admin/clientes"><i class="fa fa-book"></i> <span>Clientes</span></a></li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 Case Love Case.</strong> All rights
        reserved.
    </footer>
