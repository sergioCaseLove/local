...
<head>
    ...
    <script src="/js/editorVendor2.js"></script>
    <script src="/js/editors2.js"></script>

</head>

<body ng-app="main" ng-controller="mainCtrl" class="gothamFont">
<div id="wrapper">
    <input name="hdnTipoCase" type="hidden" id="hdnTipoCase" vid="hdnTipoCase" value="SLIMCASES">
...
border-radius: 10px;" class="form-control">
    ...
    <div id="page-wrapper">
        ...
        <div class="header-x">
            <!--
            <button style="margin:15px !important;" ng-click="elegirTipo()" class="btn btn-default hidden-xs">
                Tipo de Case: {[{tipoSeleccionado}]}
                <li class="fa fa-arrow-down"></li>
            </button>
            <button style="margin-top: 15px !important; margin-left: 15px !important;" ng-click="elegirTipo()"
            ...
            <div class="lineHeader3 hidden-sm hidden-md hidden-lg">
                <div class="col-xs-3" style="padding-left: 0px!important;"><h3>$299</h3></div>
                <div class="col-xs-20">
                    <a class="btn btn-default boton-hover" style="background-color:#ff017e; color:white; font-weight: bold;" ng-click="guardar()">Comprar</a>
                    <p style="font-weight: bold;">Envío incluido</p>    
                </div>
