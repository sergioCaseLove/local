...
<div id="wrapper">
    ...
    <div ng-show="menu.agregarTextoMenu" class="popMenu" style="width: 25%;display:none">
        <h3> Agregar Texto</h3>
...
border-radius: 10px;" class="form-control">
    ...
    <div ng-show="menu.modificarFondoMenuModal" class="popMenuModal" style="display:none">
    ...
    <div ng-show="menu.agregarTextoMenuModal" class="popMenuModal" style="display:none">
        <h3> Agregar Texto</h3>
        <div style="position:absolute;right:0;top:0;">
            <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
        </div>
...
border-radius: 10px;" class="form-control">
    ...
    <div ng-show="menu.modificarFondoMenu" class="popMenu" style="width: 250px; display:none">
        <h3> Color de fondo</h3>
            ...
            <div class="lineHeader3 hidden-sm hidden-md hidden-lg">
                <table style="margin-right:15px">
                    <tbody>
                        <tr style="">
                            <td>
                                <div class="" style="padding-left:important;"><h3>$299</h3></div>
                            </td>
                            <td>
                                <div class="">
                                    <a class="btn btn-default boton-hover" style="background-color:#ff017e; color:white; font-weight: bold;" ng-click="guardar()">Comprar</a>
...
<div id="gifFondo" ng-class="gifFondo"
     class="gifFondo">
    <img src="/images/Heart.gif" id="gifCarga" style="top:50%;left:50%;position:fixed;margin-left:-250px;margin-top:-187px;">
