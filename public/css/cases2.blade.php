<div ng-show="menu.elegirTipo" class="popMenuModal hidden-sm hidden-md hidden-lg">
...
<div ng-show="menu.elegirTipo" class="popMenuModalDesktop hidden-xs">
    <h3>Seleccionar Tipo de Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirMarcaAntishock" class="popMenuModal hidden-sm hidden-md hidden-lg">
...
<div ng-show="menu.elegirMarcaAntishock" class="popMenuModalDesktop hidden-xs">
    <h3>Seleccionar Marca</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>    
...
<div ng-show="menu.elegirMarcaRubberCase" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Marca</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>    
...
<div ng-show="menu.elegirMarcaRubberCase" class="popMenuModalDesktop hidden-xs">
    <h3>Seleccionar Marca</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>    
...
<div ng-show="menu.elegirMarca" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Marca</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirMarca" class="popMenuModalDesktop hidden-xs">
    <h3>Seleccionar Marca</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirMarcaSlim" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Marca</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>   
...
<div ng-show="menu.elegirMarcaSlim" class="popMenuModalDesktop hidden-xs">
    <h3>Seleccionar Marca</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseHTC" class="popMenuModal hidden-sm hidden-md hidden-lg">
...
<div ng-show="menu.elegirCaseHTC" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseZTE" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseZTE" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseSony" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseSony" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseSamsung" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseSamsung" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseLG" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseLG" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseNexus" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseNexus" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseMotorola" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseMotorola" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseApple" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirCaseApple" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirRubberCaseApple" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirRubberCaseApple" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirRubberCaseSamsung" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirRubberCaseSamsung" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirAntishockCaseApple" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirAntishockCaseApple" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirAntishockCaseSamsung" class="popMenuModal hidden-sm hidden-md hidden-lg">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
...
<div ng-show="menu.elegirAntishockCaseSamsung" class="popMenuModalDesktop hidden-xs">
    <h3> Seleccionar Case</h3>
    <div style="position:absolute;right:0;top:0;">
        <a style="" ng-click="cerrarTodosLosMenus()"><img src="/images/icons/close.png" alt="x"></a>
    </div>
